...
class TestMoodleKitDocker(unittest.TestCase):
    ...
    def test_render_config_php_moodle5(self):
    ...
    def test_render_config_php_moodle4(self):
        tpl_path = BASE_DIR / "docker" / "templates" / "config.php.tpl"
        context = {
            "SLUG": "tenant2",
            "DOMAIN": "tenant2.example.com",
            "WWWROOT": "https://tenant2.example.com",
            "DB_TYPE": "mariadb",
            "DB_HOST": "db",
            "DB_PORT": "3306",
            "DB_NAME": "moodle_tenant2",
            "DB_USER": "moodle_tenant2",
            "DB_PASS": "secretpass456",
            "DB_PREFIX": "mdl_",
            "SSLPROXY": "true",
            "IS_MOODLE5": False,
        ...
        rendered = moodlekit_docker.render_template(tpl_path, context)
        self.assertIn("$CFG->wwwroot   = 'https://tenant2.example.com';", rendered)
        self.assertNotIn("$CFG->routerconfigured = true;", rendered)
        self.assertNotIn("$CFG->session_handler_class", rendered)
    ...
    def test_cli_parser(self):
        ...
        args = parser.parse_args(["site", "create", "testsite", "-d", "testsite.org", "--plan", "big", "-m", "5.2"])
